...
<body>
    ...
    <nav class="sticky top-0 bg-white bg-opacity-70 backdrop-blur-lg w-full z-10">
        <div class="flex justify-between items-center pt-8 pb-6 px-4 md:px-14">
            ...
            <div class="hidden md:flex gap-5">
                <a href="index.html" class="text-lg text-gray-700 mx-3 hover:font-semibold hover:text-blue-600">Beranda</a>
                <a href="aboutUs.html" class="text-lg text-gray-700 mx-3 hover:font-semibold hover:text-blue-600">Tentang Kami</a>
                <a href="fitur.html" class="text-lg text-gray-700 mx-3 hover:font-semibold hover:text-blue-600">fitur</a>
                <a href="solusiKami.html" class="text-lg text-gray-700 mx-3 hover:font-semibold hover:text-blue-600">Solusi Kami</a>
            </div>
        ...
        <div id="mobileMenu" class="hidden md:hidden px-4 pb-4 bg-white">
            <div class="flex flex-col space-y-4">
                <a href="index.html" class="text-lg text-gray-700 hover:text-blue-600">Beranda</a>
                <a href="aboutUs.html" class="text-lg text-gray-700 hover:text-blue-600">Tentang Kami</a>
                <a href="fitur.html" class="text-lg text-gray-700 hover:text-blue-600">Fitur</a>
                <a href="solusiKami.html" class="text-lg text-gray-700 hover:text-blue-600">Solusi Kami</a>
                <a href="login.php">
    ...
    <!-- Hero Section -->
    <div id="slideContainer" class="relative w-full h-[600px] md:h-screen bg-cover bg-center -mt-24 hero-bg" style="background-image: url('assets/image/cover.png');">
        <section>
        ...
        <div class="flex flex-col px-6 md:px-24">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
                ...
                <div class="flex flex-col md:flex-row items-center">
                    ...
                    <div>
                        <div class="flex bg-green-200 rounded-3xl overflow-hidden w-48 h-48 md:w-64 md:h-64 items-center justify-center">
                            <img src="assets/image/role bisnis.png" alt="role bisnis" class="h-40 md:h-56 object-cover">
                        </div>
                    </div>
                </div>
                <!-- Layanan Individu -->
                <div class="flex flex-col-reverse md:flex-row-reverse items-center">
                    ...
                    <div>
                        <div class="flex bg-green-200 rounded-3xl overflow-hidden w-48 h-48 md:w-64 md:h-64 items-center justify-center">
                            <img src="assets/image/role individu.png" alt="role individu" class="h-40 md:h-56 object-cover">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-14 px-6 md:px-20">
                ...
                <div class="flex flex-col items-center text-center">
                    <div class="bg-white shadow-xl rounded-3xl p-4">
                        <img src="assets/image/pickup.png" alt="pickup" class="w-32 md:w-44 object-contain">
                    </div>
                ...
                <div class="flex flex-col items-center text-center">
                    <div class="bg-white shadow-xl rounded-3xl p-4">
                        <img src="assets/image/reward.png" alt="reward" class="w-32 md:w-44 object-contain">
                    </div>
                ...
                <div class="flex flex-col items-center text-center">
                    <div class="bg-white shadow-xl rounded-3xl p-4">
                        <img src="assets/image/report.png" alt="laporan" class="w-32 md:w-44 object-contain">
                    </div>
                ...
                <div class="flex flex-col items-center text-center">
                    <div class="bg-white shadow-xl rounded-3xl p-4">
                        <img src="assets/image/education.png" alt="edukasi" class="w-32 md:w-44 object-contain">
                    </div>
    ...
    <section class="relative bg-fixed bg-cover bg-center bg-no-repeat text-white py-20 md:py-40 mt-16 md:mt-32" style="background-image: url('assets/image/together.jpg');">
    ...
    <section id="our-team" class="mt-16 md:mt-32">
        <div class="container mx-auto text-center px-6 md:px-24">
            ...
            <div class="flex flex-wrap justify-center gap-8 md:gap-12">
                <!-- Card Member 1 -->
                <div class="text-center">
                    <img src="assets/image/zed.png" alt="founder itrashy" class="w-40 h-40 md:w-52 md:h-52 object-cover rounded-3xl mx-auto mb-4">
                    <h2 class="text-base md:text-lg font-semibold">Izzedine Elfatih</h2>
                    <p class="text-sm text-gray-600">Founder</p>
                </div>
                <!-- Card Member 2 -->
                <div class="text-center">
                    <img src="assets/image/kev.png" alt="founder itrashy" class="w-40 h-40 md:w-52 md:h-52 object-cover rounded-3xl mx-auto mb-4">
                    <h2 class="text-base md:text-lg font-semibold">Kevin Tri Putra</h2>
                    <p class="text-sm text-gray-600">Founder</p>
                </div>
                <!-- Card Member 3 -->
                <div class="text-center">
                    <img src="assets/image/han.png" alt="founder itrashy" class="w-40 h-40 md:w-52 md:h-52 object-cover rounded-3xl mx-auto mb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="space-y-6">
                    <a href="#" class="flex items-center space-x-3">
                        <img src="assets/image/Logo Itrashy.png" class="h-12 md:h-16" alt="iTrashy Logo" />
